...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PortfolioItemImage.title'
        db.add_column(u'main_portfolioitemimage', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'PortfolioItemImage.subtitle'
        db.add_column(u'main_portfolioitemimage', 'subtitle',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'PortfolioItemImage.desc'
        db.add_column(u'main_portfolioitemimage', 'desc',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PortfolioItemImage.title'
        db.delete_column(u'main_portfolioitemimage', 'title')

        # Deleting field 'PortfolioItemImage.subtitle'
        db.delete_column(u'main_portfolioitemimage', 'subtitle')

        # Deleting field 'PortfolioItemImage.desc'
        db.delete_column(u'main_portfolioitemimage', 'desc')
